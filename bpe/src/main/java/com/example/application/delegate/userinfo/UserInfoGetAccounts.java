package com.example.application.delegate.userinfo;
...
@Component
@Slf4j
public class UserInfoGetAccounts implements JavaDelegate {

    private final KafkaTemplate<String, String> kafkaTemplate;
    private final SynchroChannel channel;

    public UserInfoGetAccounts(KafkaTemplate<String, String> kafkaTemplate, SynchroChannel channel) {
    ...
    public void execute(final DelegateExecution execution) {
        ...
        kafkaTemplate.send("userInfoRq", JsonUtil.toJson(commandMessage));
    ...
    @KafkaListener(topics = "userInfoRs", groupId = "userInfo")
    public void receive(
            String message,
